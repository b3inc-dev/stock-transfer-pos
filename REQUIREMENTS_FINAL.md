...
| **ロス・発注・仕入・調整** | ✅ 完了 | 各履歴・商品リスト・CSV項目設定。調整は簡易棚卸（activity=adjustment）。商品リストの初回表示件数は productList.initialLimit に統一。**2026-02-25** 履歴詳細の商品リストで設定の初回表示件数と「さらに読み込む」を追加（*HistoryList.jsx）。各 extensions の *ProductList.jsx, *HistoryList.jsx, app.settings.tsx |
