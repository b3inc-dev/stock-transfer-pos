...
| **在庫高・変動履歴** | ✅ 完了 | スナップショット共通化・Cron・トークンリフレッシュ、変動はDB・OrderPendingLocation/RefundPendingLocation・売上/返品/キャンセル戻り/調整反映・二重防止・救済API。app.inventory-info.tsx, api.log-inventory-change, webhooks.*, app/utils/inventory-snapshot.ts |
